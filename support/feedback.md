...
Files are stored at `~/.notebooklm-paper-skill/feedback/` with the naming pattern `YYYY-MM-DD-<phase>.md`.
...
To review collected feedback, read all files from `~/.notebooklm-paper-skill/feedback/` and summarize:
