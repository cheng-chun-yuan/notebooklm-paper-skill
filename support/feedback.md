...
Files are stored at `~/.paper-skill/feedback/` with the naming pattern `YYYY-MM-DD-<phase>.md`.
...
To review collected feedback, read all files from `~/.paper-skill/feedback/` and summarize:
