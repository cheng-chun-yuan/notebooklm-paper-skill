...
Save location: `~/.notebooklm-paper-skill/projects/{name}/field-map.md`
...
Save the aggregated analysis to `~/.notebooklm-paper-skill/projects/{name}/gaps.md`. Follow the structure shown in the Structural Exemplar above.
...
Compile all findings into `~/.notebooklm-paper-skill/projects/{name}/inspiration-map.md`. Follow the structure shown in the Structural Exemplar above.

---

## Output

This phase produces the following artifacts in `~/.notebooklm-paper-skill/projects/{name}/`:
